...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        val imageSwith: ImageView = findViewById(R.id.imageView2)
        val textSwith: TextView = findViewById(R.id.text_action)
        imageSwith.setOnClickListener{
            imageSwith.setImageResource(R.drawable.lemon_squeeze)
            textSwith.setText("Click to juice the lemon")
        }
